...
const MapHeatmap = lazy(
  () => import('../../../sections/overview/extra/map/heatmap')
)
const MapGeojson = lazy(
  () => import('../../../sections/overview/extra/map/geojson')
)
const MapClusters = lazy(
  () => import('../../../sections/overview/extra/map/MapClusters')
)
const MapInteraction = lazy(
  () => import('../../../sections/overview/extra/map/interaction')
)
const MapChangeTheme = lazy(
  () => import('../../../sections/overview/extra/map/change-theme')
)
